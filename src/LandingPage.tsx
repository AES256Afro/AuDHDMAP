    ...
    <main id="top">
      <section className="site-hero">
        <div className="site-hero-copy">
          <div className="site-kicker"><i /> VERSION 0.8.0 <span>PUBLIC DEMO</span></div>
          ...
          <div className="site-proof" aria-label="Product details"><span><b>●</b> Browser-only demo</span><span><b>●</b> Docker image</span><span><b>●</b> Private server storage</span></div>
        </div>
      ...
      <section className="site-section site-screens" id="screens">
        <header className="site-section-heading"><div><span className="site-label">INTERFACE</span><h2>Canvas, outline, and export</h2></div><p>These screenshots were captured from version 0.8.0.</p></header>
      ...
      <section className="site-final-cta"><span className="site-label">PUBLIC DEMO</span><h2>Browser-only workspace</h2><p>No password is required. Changes stay in the current tab and are removed when it closes. Export sends only the selected map for file generation.</p><a className="site-button" href="/demo">Open demo <span aria-hidden="true">↗</span></a></section>
    </main>

    <footer className="site-footer"><a className="site-brand" href="#top"><span>⌘</span><strong>AuDHDMAP</strong></a><p>Version 0.8.0</p><nav><a href="https://github.com/AES256Afro/AuDHDMAP">Source</a><a href="https://github.com/AES256Afro/AuDHDMAP/blob/main/docs/SECURITY.md">Security</a><a href="/demo">Demo</a></nav></footer>
