export function defaultWorkspace(now = new Date()) {
  ...
  return {
    ...
    nodes: [
      {
        ...
        x: 80, y: 260, width: 220, shape: "rounded", categoryId: "decision", tags: ["server"], attachments: [],
      ...
      },
      {
        ...
        x: 390, y: 120, width: 190, shape: "rounded", categoryId: "evidence", tags: ["hardware"], attachments: [],
      ...
      },
      {
        ...
        x: 390, y: 260, width: 210, shape: "rounded", categoryId: "decision", tags: ["storage", "backup"], attachments: [],
      ...
      },
      {
        ...
        x: 700, y: 130, width: 190, shape: "rounded", categoryId: "question", tags: ["recovery"], attachments: [],
      ...
      },
      {
        ...
        x: 390, y: 430, width: 190, shape: "rounded", categoryId: "risk", tags: ["network"], attachments: [],
      ...
      },
      {
        ...
        x: 700, y: 400, width: 190, shape: "rounded", categoryId: "action", tags: ["apps"], attachments: [],
      ...
      },
      {
        ...
        x: 700, y: 270, width: 190, shape: "rounded", categoryId: "action", tags: ["recovery"], attachments: [],
      ...
      },
      {
        ...
        x: 180, y: 180, width: 210, shape: "rounded", categoryId: null, tags: [], attachments: [], task: null, createdAt, updatedAt: createdAt,
      },
    ],
    edges: [
    ...
    groups: [
      { id: "group-preparation", mapId: "map-home-server", title: "Preparation", x: 350, y: 70, width: 600, height: 310, color: "#47b6a8", shape: "rectangle", collapsed: false },
    ],
    settings: {
      theme: "quiet",
      snapToGrid: true,
