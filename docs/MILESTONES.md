...
## 0.6.1 through 0.6.7 - Hardened daily interaction
...
- Filesystem-heavy restore, attachment, and application fallback routes enforce bounded per-IP request rates before doing their expensive work.
